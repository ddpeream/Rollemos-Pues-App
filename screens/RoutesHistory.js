...
export default function RoutesHistory() {
  ...
  const getMapPreviewUrl = (route) => {
    ...
    return `https://maps.googleapis.com/maps/api/staticmap?size=400x200&path=color:0x4DD7D0FF|weight:3|${path}&markers=color:green|label:S|${start.latitude},${start.longitude}&key=YOUR_API_KEY`;
  };
