...
/**
 * SkaterSearchFilter - Componente independiente de búsqueda y filtrado
 * 
 * Props:
 *   - draftFilters: {searchText, ciudad, disciplina, nivel} - Estado actual de filtros
 ...
 */
export default function SkaterSearchFilter({
  draftFilters,
  onFiltersChange,
  onApplyFilters,
  allCities,
  ...
  const handleSearchTextChange = useCallback((text) => {
    onFiltersChange(prev => ({ ...prev, searchText: text }));
  }, [onFiltersChange]);

  // Limpia el search text
  const handleClearSearch = useCallback(() => {
    onFiltersChange(prev => ({ ...prev, searchText: '' }));
  }, [onFiltersChange]);
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity
        style={[
          ...
          isLoading && styles.applySearchButtonDisabled,
        ]}
